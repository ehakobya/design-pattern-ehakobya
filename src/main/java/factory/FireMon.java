...
public class FireMon extends CodeAMon {
    ...
    /**
     * Constructor for the FireMon class, which initializes
     ...
     * "FIRE BALL" ability, and any weather or type bonuses or penalties.
    ...
    public int attack(CodeAMon opponent, String weather) {
        ...
        int dealtDamage = this.getAttack() + this.getAbilities().get("FIRE BALL");
